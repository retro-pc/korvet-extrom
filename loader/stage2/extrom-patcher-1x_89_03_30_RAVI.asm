...
;  	;DW part
	...
	db 	pW_CHK_PATCH
	dw 	0xdeb4+1,0xE615,res_GETINFO 	;GET_INFO_CALL а это call внутри SELDSK
	...
	db 	0x21,0x21
	db 	pW_CHK_PATCH
	dw	0xE655+1,0xE685,0xE685 	

	db 	pW_STORE
	dw 	0xE655,_old_getinfo_chkdo+1 	
...
; 	;kbd hook
	...
	db 	pW_CHK_PATCH
	dw 	0xE843,0xDCAD,kbd_hook_noCtrl_03
	db 	pW_STORE
