...
; При работе системы буквы дисков по умолчанию на ПК8020 отобажаются так:
;     A - эмулируемый диск 0
;     B - эмулируемый диск 1
;     C - физический дисковод 0
;     D - физический дисковод 1
;     E - инструментальный диск
;     F - рамдиск
;
; На ПК8010, где нет физических дисководов, буквы дисков отображаются по-другому:
;     A - эмулируемый диск 0
;     B - эмулируемый диск 1
;     C - эмулируемый диск 2
;     D - эмулируемый диск 3
;     E - инструментальный диск
;     F - рамдиск
;
; Отображение букв дисков в любой момент может быть изменено утилитой MOUNT, а значения по умолчанию - несложной
; правкой данного исходного текста.
;
...
TRNS03:
;таблица параметров MOUNT-диска E - обычный KDI
CPMT04:
...
SISNON:		
	...
	DB	'EXTROM disk emulation BIOS v1.03 ',0DH,0AH,0
...
; 	CP	5		; 
; 	JP	Z,EMUREAD	; 5 - Mount-диск, физическим не бывает
	LD	HL,(CPMT)	; адрес маски выбора
	LD	A,(HL)
	OR	A		; диски А или В ?
	JP	NZ,READ_FDD	; нет - это реальные дисководы
...
GETINFO:
	...
	LD	(DREG),A
	CP	0	; эмулируемый диск? У них нет маски выбора
